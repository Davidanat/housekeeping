<template>
    <div>
        <h3 class="text-gray-700 text-3xl font-medium">Employee Data</h3>

        <div class="mt-8">
            <h4 class="text-gray-600">List of Employee</h4>

            <div class="mt-6">
                <h2 class="text-xl font-semibold text-gray-700 leading-tight">Employee</h2>
                            ...
                            <tbody>
                                <tr v-for="(u, index) in paginatedTableData" :key="index">
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                                    >
                                        <p class="text-gray-900 whitespace-no-wrap">{{ u.id_number }}</p>
                                    </td>
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                                    >
